                ...
                renderItem={({ item }) => (
                    <View>
                        <View className="p-4 m-2 bg-white rounded-lg shadow-md">
                            ...
                            <Text className="text-gray-600">Transmission: {item.transmission}</Text>
                            <Text className="text-gray-600">Top speed: {item.top_speed_kmh} km/h</Text>
                            <Text className="text-gray-600">Acceleration (0 to 100 km/h): {item.acceleration_0_to_100_kmh} sec</Text>
                            <Text className="text-gray-600">Horsepower: {item.horsepower} hp</Text>
                            <Text className="text-gray-600">Seating capacity: {item.seating_capacity}</Text>
                        </View>
                    </View>
                )}
